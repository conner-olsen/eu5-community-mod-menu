...
- `in_game/common/scripted_effects/cmm_core_basic_setting_effects.txt`
- `in_game/common/scripted_effects/cmm_core_numeric_registration_effects.txt`
- `in_game/common/scripted_effects/cmm_core_slider_registration_effects.txt`
- `in_game/common/scripted_effects/cmm_core_dropdown_registration_effects.txt`
- `in_game/common/scripted_effects/cmm_core_shared_runtime_effects.txt`
- `in_game/common/scripted_effects/cmm_core_numeric_slider_runtime_effects.txt`
